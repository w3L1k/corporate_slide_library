...
- сворачиваемая боковая навигация, освобождающая место в узкой панели PowerPoint;
- единый русский интерфейс без неработающих пунктов и декоративных кнопок;
- локальное избранное с сохранением между перезапусками панели;
- локальный раздел «Недавние» с последними успешно вставленными слайдами;
